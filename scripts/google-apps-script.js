 ...
 * 4. Mengirim email notifikasi resep & link Google Drive ke Admin & Mikael
 * 
 * Petunjuk pemasangan lengkap dapat dilihat di file: PANDUAN_SETUP_GOOGLE_SHEETS.md
 */

// Daftar email admin tujuan notifikasi (hanya dikirim ke admin halulagikh dan mikaelaldy56)
...
function doPost(e) {
  try {
    ...
    // 3. Kirim Email Notifikasi HANYA ke Admin & Developer
...
/**
 * Menyimpan file Base64 ke folder Google Drive dengan izin akses terbuka (Anyone with link)
 */
...
/**
 * Mengirimkan email notifikasi ke Admin Halu Lagi Kh & Mikael
 */
