...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className={`sticky top-0 z-50 bg-[#F6C358] border-b-3 sm:border-b-4 border-[#3E2723] shadow-md transition-transform duration-300 ${navHidden ? '-translate-y-full' : 'translate-y-0'}`}>
